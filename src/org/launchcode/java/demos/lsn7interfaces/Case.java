...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Sprinkles", 0.50, new ArrayList<>(Arrays.asList("none")));
        Topping topping2 = new Topping("Fresh Strawberry", 0.25, new ArrayList<>(Arrays.asList("strawberry")));
        Topping topping3 = new Topping("Caramel", 0.40, new ArrayList<>(Arrays.asList("none")));
        Topping topping4 = new Topping("Chocolate",0.30, new ArrayList<>(Arrays.asList("dairy")));
